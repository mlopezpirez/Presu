...
begin
  if not exists (
    ...
    where schemaname = 'public'
      ...
      and policyname = 'Allow all on finance_settings'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'public'
      ...
      and policyname = 'Allow all on household_members'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'public'
      ...
      and policyname = 'Allow all on budget_categories'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'public'
      ...
      and policyname = 'Allow all on import_batches'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'public'
      ...
      and policyname = 'Allow all on fixed_expenses'
  ) then
  ...
  if not exists (
    ...
    where schemaname = 'public'
      ...
      and policyname = 'Allow all on transactions'
  ) then
  ...
  if not exists (
    select 1 from pg_policies
    where schemaname = 'public'
      and tablename = 'budget_scenarios'
      and policyname = 'Allow all on budget_scenarios'
  ) then
